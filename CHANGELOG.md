...
* Correctly handle removal of GetFeatureInfo capability when refreshing sources ([#1474](https://github.com/mapbender/mapbender/issues/1474), [PR#1487](https://github.com/mapbender/mapbender/pull/1487))
