...
* Add option to disable newly added layers during WMS update in GUI and via argument `--disable-new-layers` in `mapbender:wms:reload:url` command ([PR#1447](https://github.com/mapbender/mapbender/pull/1447))
