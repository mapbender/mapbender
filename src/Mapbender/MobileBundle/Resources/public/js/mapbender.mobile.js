$(function(){
    ...
    var map_id = $('.mb-element-map').attr('id');
    if (!Mapbender.checkTarget("mobile handling", map_id)) {
        Mapbender.error('Map element is not found');
    } else {
        Mapbender.elementRegistry.onElementReady(map_id, $.proxy(initMobile));
    }
});