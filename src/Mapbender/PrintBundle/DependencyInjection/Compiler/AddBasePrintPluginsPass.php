...
class AddBasePrintPluginsPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        if ($container->getParameter('mapbender.print.queueable')) {
            $hostDefinition->addMethodCall('registerPlugin', [
     ...
     * @return mixed
     */
    protected function resolveParameterReference(ContainerBuilder $container, $value): bool|int|float|\UnitEnum|string|array|null
    {
        if (is_string($value)) {
