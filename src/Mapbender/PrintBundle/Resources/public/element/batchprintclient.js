(function($) {
    ...
    $.widget("mapbender.mbBatchPrintClient", $.mapbender.mbPrintClient, {
        // Frame management (initialized in _setup)
        frameManager: null,
        
        // Rotation controller (initialized in _setup)
        rotationController: null,
        
        // Table controller (initialized in _setup)
        ...
        // Style configuration (initialized in _setup)
        styleConfig: null,
         ...
         * @private
         */
        _setupPropertyProxies: function() {
            var self = this;
         ...
         */
        _collectAllJobData: async function() {
         ...
         */
        _submitBatchJobs: function(jobs) {
            if (!this.$form || !this.$form.length) {
         ...
         */
        _restoreUIState: function(selectionCenter) {
            var self = this;
         ...
         * @private
         */
        _placeFrameAtPosition: function(coord, bearing, previousRotation) {
         ...
         * @param {Array} selectionCenter - Center coordinates to restore selection feature
         */
        _handleSubmissionError: function(error, selectionCenter) {
