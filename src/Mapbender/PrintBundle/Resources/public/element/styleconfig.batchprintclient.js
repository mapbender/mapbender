...
(function() {
    ...
    Mapbender.BatchPrintStyleConfig = function(overrides) {
        // Colors
     ...
     * @private
     */
    Mapbender.BatchPrintStyleConfig.prototype._toRgba = function(cssColor, opacity) {
        var rgb = Mapbender.StyleUtil.parseCssColor(cssColor);
     ...
     */
    Mapbender.BatchPrintStyleConfig.prototype.createDefaultFrameStyle = function() {
     ...
     */
    Mapbender.BatchPrintStyleConfig.prototype.createHighlightedFrameStyle = function(feature) {
     ...
     * @returns {ol.style.Style}
     */
    Mapbender.BatchPrintStyleConfig.prototype.createRotationBoxStyle = function() {
        return new ol.style.Style({
            stroke: new ol.style.Stroke({
                color: this.highlightColor,
     ...
     * @returns {ol.style.Style}
     */
    Mapbender.BatchPrintStyleConfig.prototype.createRotationHandleStyle = function() {
        return new ol.style.Style({
     ...
     * @returns {ol.style.Style}
     */
    Mapbender.BatchPrintStyleConfig.prototype.createTrackLineStyle = function() {
        return new ol.style.Style({
            stroke: new ol.style.Stroke({
     ...
     * @returns {ol.style.Style}
     */
    Mapbender.BatchPrintStyleConfig.prototype.createTrackPointStyle = function() {
        return new ol.style.Style({
            image: new ol.style.Circle({
     ...
     * @returns {ol.style.Style}
     */
    Mapbender.BatchPrintStyleConfig.prototype.createEmptyStyle = function() {
        return new ol.style.Style({});
    };
