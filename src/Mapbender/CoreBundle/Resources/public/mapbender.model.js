...
window.Mapbender.MapModelOl4 = (function () {
    ...
    Object.assign(MapModelOl4.prototype, {
        ...
        _extractSvgLabelStyle: function (olTextStyle) {
            ...
            if (font) {
                style = this._parseCssFontDeclarationIntoStyle(font, style);
            }
        ...
        _parseCssFontDeclarationIntoStyle: function (font, style) {
            // css font is a potentially long and ambigious string (https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/font)
            // Instead of trying to recreate the grammar, use the browser to parse it for us
            const declaration = document.createElement('span').style;
            declaration.font = font.trim();

            if (!declaration.font || !declaration.fontSize || !declaration.fontFamily) {
                return style;
            }

            style['fontWeight'] = declaration.fontWeight;
            style['fontStyle'] = declaration.fontStyle;
            ...
            style['fontFamily'] = declaration.fontFamily;
            return style;
        },
        /**
