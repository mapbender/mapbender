    ...
    Object.assign(MapModelBase.prototype, {
        ...
        _checkForChangedSourcesAndUnprocessableLayers: function(settings) {
            ...
            if (remaining_id_found) {
                alert("Auf dem Server haben sich die IDs der Datenquellen geändert. Um einen reibungslosen Ablauf zu gewährleisten, wird empfohlen, den Layerbaum neu zu laden. Drücken Sie dafür den 'Neu laden' Button in der Werkzeugleiste. Sollten Sie 'Eigene Layereinstellungen' im Layerbaum nutzen, empfiehlt es sich ebenso, diese zu entfernen und neu anzulegen.");
            }
