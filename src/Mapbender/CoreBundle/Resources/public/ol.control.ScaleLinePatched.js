 ...
 * @constructor
 */
ol.control.ScaleLinePatched = function(options) {
    ol.control.ScaleLine.call(this, options);
};

ol.control.ScaleLinePatched.prototype = Object.create(ol.control.ScaleLine.prototype);
ol.control.ScaleLinePatched.prototype.constructor = ol.control.ScaleLinePatched;

/**
 * Fixed updateElement_ method. Mostly Copy & paste of (quite monolithic) upstream version.
 * @private
 */
ol.control.ScaleLinePatched.prototype.updateElement_ = function() {
