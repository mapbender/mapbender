...
use FOM\UserBundle\Security\Permission\YamlBaseVoter;
...
class ImportHandler extends ExchangeHandler
{
    ...
    protected function duplicatePermissions(ImportState $importState, Application $app): void
    {
        $entityArray = [
            $app,
            ...$app->getElements(),
            ...$app->getSharedInstanceAssignments(),
            ...$app->getSourceInstances(false),
        ];
