 ...
 * @author Paul Schmidt
 */
class WmtsMetadata extends SourceMetadata
{
//
//    protected $instance;
//
//    public function __construct(WmtsInstance $instance)
//    {
//        parent::__construct();
...
//                if ($layerH->getWmtslayersource()->getName() === $itemName) {
//                    $layer = $layerH;
//                    break;
//                }
//            }
...
//    {
//        $layer_items = array();
//        $layer_items[] = array("name" => SourceMetadata::getNotNull($layer->getWmtslayersource()->getName()));
//        $layer_items[] = array("title" => SourceMetadata::getNotNull($layer->getTitle()));
//        $bbox = $layer->getWmtslayersource()->getLatlonBounds();
//        $layer_items[] = array("bbox" => SourceMetadata::getNotNull($bbox->getSrs() . " " .
//                $bbox->getMinx() . "," . $bbox->getMiny() . "," . $bbox->getMaxx() . "," . $bbox->getMaxy()));
//        $layer_items[] = array(
//            "srs" => SourceMetadata::getNotNull(implode(', ', $layer->getWmtslayersource()->getSrs())));
...
//            array('metadata' => $this->data, 'prefix' => 'mb.wmts.metadata.section.'));
//        return $content;
//    }
