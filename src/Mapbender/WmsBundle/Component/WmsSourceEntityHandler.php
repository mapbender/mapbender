...
class WmsSourceEntityHandler extends SourceEntityHandler
{
    ...
    public function createInstance(Layerset $layerSet = NULL)
    {
        ...
        $this->initializeLayerOrder($instance);
        return $instance;
    }
     ...
     * @internal
     * @todo: This is copy&pasted from WmsInstanceEntityHandler (disjoint hierarchy) and really belongs in a service
     */
    protected function initializeLayerOrder(WmsInstance $entity)
    {
