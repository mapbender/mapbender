...
- symfony/symfony dependency was unpacked to use individual symfony/* subpackages. By default, only the dependencies
  ...
  check [this page](https://github.com/symfony/symfony/blob/5.4/composer.json#L58) for the dependency that might be needed and install it manually to your project using `./bin/composer install symfony/your-bundle`
...
- Doctrine: updated ORM from 2.10 to 2.15 and DBAL from 2.11 to 3
  ...
  - Parameters `database_driver`, `database_host`, `database_port`, `database_name`, `database_path`, `database_user`, `database_password`
      ...
      See [Doctrine Project](https://www.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/configuration.html#connecting-using-a-url) for details
