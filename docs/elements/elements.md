...
- `options.autoOpen`, `options.autoStart`, `options.autoActivate`: If any of these options exist and are set to true, a connected button will be shown as active on application load (as long as the element is in the content area and visible)s
